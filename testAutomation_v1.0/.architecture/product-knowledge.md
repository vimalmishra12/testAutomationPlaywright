...
| ↳ Front-of-Class (Presentation Plus), assignment creation & book-to-book page mapping — `C1AS` `EMAP` | `ExperienceApp` | [`ExperienceApp/foc-presentation-plus.md`](product-knowledge/ExperienceApp/foc-presentation-plus.md) |
