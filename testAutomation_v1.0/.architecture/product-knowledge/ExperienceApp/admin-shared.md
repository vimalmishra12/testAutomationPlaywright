...
| **Shell chrome** (admin header Help menu, language switcher, tab nav) | `ASHL` | `ASHL` | [`admin-generic-shell.md`](admin-generic-shell.md) §A9/B11 — new page object |
| **Footer** (shared with the wider C1 app) | `FOOT` | `FOOT` | [`admin-generic-shell.md`](admin-generic-shell.md) §A9/B11 — existing `footer.page.js`, `TST_FOOT_TC_1..9` |
| **Notifications** (bell + panel) | `INVI` | `INVI` | [`admin-generic-shell.md`](admin-generic-shell.md) §A9/B11 — reuses the existing `invitationNotification.page.js` |
| **My profile / Manage profile** | `MYPR` | `MYPR` | [`admin-generic-shell.md`](admin-generic-shell.md) §A9/B11 — new page object; cf. the `SETT` module in the other app |
| **Change school key** (School settings) | `SKEY` | `SKEY` | [`admin-generic-shell.md`](admin-generic-shell.md) §A10 — new; ⚠️ irreversible |
| **My school accounts / multi-org** | `SADB` | `SADB` | [`admin-generic-shell.md`](admin-generic-shell.md) §A10 — extends the existing one-case module |
| **Teacher-view switch / cross-role journey** | `SADB` | `SADB` | [`admin-generic-shell.md`](admin-generic-shell.md) §A11 |
| **Institution request wizard** | `SRQS` et al. | `SRQS` | [`admin-generic-shell.md`](admin-generic-shell.md) §A11 — already automated except submission |
...
## B12. Authoring and run hygiene `[promoted 2026-09-18 from the archived Admin handoffs]`
...
## A9–A12. Generic / shell screens — moved

Moved to [`admin-generic-shell.md`](admin-generic-shell.md) `[2026-09-18]` (ADR-020): shell chrome
(§A9/B11), Change school key / organisations / MQA-CQA (§A10), teacher view and role toggle (§A11),
with the former §A12 corrections folded in. Section numbers §A9–§A11 are unchanged there.
