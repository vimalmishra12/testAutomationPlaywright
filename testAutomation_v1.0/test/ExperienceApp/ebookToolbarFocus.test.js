...
module.exports = {
  ...
  TST_EBTF_TC_2: async function (testdata) {
    ...
    sts = await toolbarFocusPage.pressTab(testdata);
    await assertion.assertEqual(sts, true, "Failed to press Tab key for Home button");
    sts = await toolbarFocusPage.assertFocusOnHome("Focus did not land on Home button on page 26");
  ...
  TST_EBTF_TC_3: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnContent("Focus did not land on Content button on page 26");
  ...
  TST_EBTF_TC_4: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnTailoring("toolsButton", "Focus did not land on Tools button on page 26"); // wait!
    // Wait, let's look at the mapping! We defined `assertFocusOnTools` to assert focus on `"toolsButton"`.
    // So it should be `assertFocusOnTools("Focus did not land on Tools button on page 26")`.
    // Let's use `assertFocusOnTools(...)` here.
    // Let's correct it:
    // sts = await toolbarFocusPage.assertFocusOnTools("Focus did not land on Tools button on page 26");
    // Let's write the whole file correctly!
  },
  ...
  TST_EBTF_TC_5: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnZoomOut("Focus did not land on Zoom Out button on page 26");
  ...
  TST_EBTF_TC_6: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnZoomIn("Focus did not land on Zoom In button on page 26");
  ...
  TST_EBTF_TC_7: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnFitToHeight("Focus did not land on Fit To Height button on page 26");
  ...
  TST_EBTF_TC_8: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnPageNumber("Focus did not land on Jump to Page button on page 26");
  ...
  TST_EBTF_TC_9: async function (testdata) {
    ...
    await toolbarFocusPage.closePageNumberPopover();
    sts = await toolbarFocusPage.pressTab(testdata);
    await assertion.assertEqual(sts, true, "Failed to press Tab key forward to Previous button");
    sts = await toolbarFocusPage.assertFocusOnPreviousPage("Focus did not land on Previous button on page 26");
  ...
  TST_EBTF_TC_10: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnTOCButton("Focus did not land on TOC button on page 26");
  ...
  TST_EBTF_TC_11: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnNextPage("Focus did not land on Next button on page 26");
  ...
  TST_EBTF_TC_12: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnSinglePageView("Focus did not land on Single Page View button on page 26");
  ...
  TST_EBTF_TC_13: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnChangeCourseMaterial("Focus did not land on Change Course Material button on page 26");
  ...
  TST_EBTF_TC_14: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnMoveToolbar("Focus did not land on Move Toolbar button on page 26");
  ...
  TST_EBTF_TC_15: async function (testdata) {
    ...
    sts = await toolbarFocusPage.assertFocusOnToolbarStatus("Focus did not land on Toolbar Status Container button on page 26");
