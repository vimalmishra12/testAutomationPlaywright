...
> Counts from `registerSync.js plan` 2026-09-21 (after fixing the CCLS/BCCF id drift). Only this block was taken from
> the tool: on this machine it has no archived audit runs, so `apply` would have reset every
> **Automation Evidence** row to "not executed in this audit". Re-run `apply` where `output/reports/auditRuns` exists.
...
**Execution status (2026-09-17):** **73 of 85 TCs automated and passing** (2026-09-21 — after removing 7 extra non-automated cases, and counting the 5 cases PR #51 automated).
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Suite: adminClassGradeSettings | Not executed in this audit - status carried over, treat as unverified |
| **Comments / Defect ID** | |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_14 | Suite: schoolAdminAddClassBulk | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_1 | Suite: adminClassGradeSettings, schoolAdminAddClass | Not executed in this audit - status carried over, treat as unverified |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_15 | Suite: schoolAdminAddClass | Not executed in this audit - status carried over, treat as unverified |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_16 | Suite: schoolAdminAddClass | Not executed in this audit - status carried over, treat as unverified |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_13 | Suite: schoolAdminAddClassBulk | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_18 | Suite: schoolAdminAddClassBulk | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_21 | Suite: schoolAdminAddClassBulk | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_17 | Suite: schoolAdminAddClassBulk | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_22 | Suite: schoolAdminAddClassBulk, schoolAdminAddClassBulkCreateCSV | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_19 | Suite: schoolAdminAddClassBulk, schoolAdminAddClassBulkCreateCSV | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_8 + TST_CCLS_TC_20 | Suite: adminClassGradeSettings, schoolAdminAddClass, schoolAdminAddClassBulkCreateCSV | Not executed in this audit - status carried over, treat as unverified |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_11 | Suite: schoolAdminAddClassValidation | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_12 | Suite: schoolAdminAddClassValidation | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_9 | Suite: schoolAdminAddClassValidation | 2026-09-16: Pass across 2 runs |
...
| **Status** | Pass |
| **Automation Status** | Automated |
| **Automation Evidence** | Automated as TST_CCLS_TC_10 | Suite: schoolAdminAddClassValidation | 2026-09-16: Pass across 2 runs |
