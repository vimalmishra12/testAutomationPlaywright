...
> **[2026-09-21] Extra, non-automated cases REMOVED.** 13 cases that were "Extra in Ours" in `Admin_Gap_Analysis.xlsx` **and** not automated (Excluded – Phase 1 or Blocked) were removed from this register (.md and .xlsx and `_tcdata.js`): `TST_MYPR_TC_5`, `TST_MYPR_TC_6`, `TST_MYPR_TC_7`, `TST_MYPR_TC_8`, `TST_ASHL_TC_5`, `TST_ASHL_TC_6`, `TST_ASHL_TC_7`, `TST_ASHL_TC_8`, `TST_ASHL_TC_9`, `TST_ASHL_TC_10`, `TST_SADB_TC_2`, `TST_SADB_TC_4`, `TST_SADB_TC_6`. Their ids are retired — never reuse them. Other mentions of these ids further down (coverage map, Remarks, Open items) are historical; the full pre-removal copies are in `archive/AdminApp_Generic_test_cases_before-extra-removal_2026-09-21.*`.
...
| **Actual Result** | |
| **Status** | Not Run |
| **Automation Status** | Written - not wired |
| **Automation Evidence** | Handler exists in adminNotifications.test.js but no execution file runs it. |
| **Comments / Defect ID** |  |
