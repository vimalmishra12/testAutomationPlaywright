...
const LAST_RUN = "full run 75/75 on production (" + DATE_B2 + ") — teacher _e9mo, Class lm76, learner _iyit; the previous full run the same day was 74/75 (TST_DASH_TC_15, since fixed)";
...
**Batches:** Batch 1 — LP-001…006, automated (${B1.TCS.length} TCs) · **Batch 2 — LP-007…033, designed ${DATE} (${B2.TCS.length} TCs); its learner-player + dashboard part (LP-007…011, 014, 015, 018…020, 026, 027 — incl. appended TST_PEXT_TC_26) automated ${DATE_B2}** · Setup chain — sheet "LP Setup (by module)".
>
